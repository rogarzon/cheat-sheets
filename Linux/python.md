...
* [Python](#python)
  ...
  * [Crear entorno virtual python2.7](#crear-entorno-virtual-python27)
    * [Instalar python2:](#instalar-python2)
    * [Instalar `virtualenv` (necesario para Python 2):](#instalar-virtualenv-necesario-para-python-2)
